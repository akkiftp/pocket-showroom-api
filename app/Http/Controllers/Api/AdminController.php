    ...
    public function overview(Request $request)
    {
        ...
        return response()->json([
            'stats'=>[
                ...
                'verified_shops'=>Business::where('is_verified',true)->count(),
                'featured_shops'=>Business::where('is_featured',true)->count(),
                'marketplace_categories'=>\App\Models\MarketplaceCategory::where('is_active',true)->count(),
                'marketplace_locations'=>\App\Models\MarketplaceLocation::where('is_active',true)->count(),
